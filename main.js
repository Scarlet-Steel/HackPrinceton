...
Instance.prototype.List=function()
{
	if (this.render==false)
	{
		...
		document.getElementById("container"+this.parent.n).innerHTML += '<div id="div'+this.n+'"><a href="javascript:Toggle('+this.n+');" style="padding-right:8px;" alt="archetype : '+(this.title)+'" title="archetype : '+(this.title)+'"><span class="arrow" id="arrow'+this.n+'">+</span><b>'+this.title+'</b><br><i style="padding-left:12px;">'+this.author+'</i></a><div id="container'+this.n+'" class="node" style="display:none;"></div></>';
		this.render = true;
	}
}
...
function Launch(source)
{
	...
	document.getElementById("div"+Seed.n).innerHTML='<a href="javascript:Toggle('+Seed.n+');" style="padding-right:8px;" alt="archetype : '+(Seed.title)+'" title="archetype : '+(Seed.title)+'"><span class="arrow" id="arrow'+Seed.n+'">+</span><b>'+Seed.title+'</b><br><i style="padding-left:12px;">'+Seed.author+'</i></a><div id="container'+Seed.n+'" class="node" style="display:none;">'+str+'</div>';
}
